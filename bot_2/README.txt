...
o	Velora: http://127.0.0.1:5000/
o	MathBot: http://127.0.0.1:5000/mathbot
________________________________________
Technology Stack
•	Frontend: HTML, CSS (custom themes for emotional and romantic vibes)
•	Backend: Python (Flask, ChatterBot)
•	Libraries Used:
o	ChatterBot for chatbot logic
o	Pint for unit conversions
________________________________________
Usage
1.	Access Velora to:
o	Get emotional support during stressful travel situations.
o	Redirect queries to other SL Voyager systems like attractions, hotels, or forecasting.

2.	Use Zara to:
o	Learn about Sri Lanka’s rich culture and traditions.

3.	Use Einstein to:
o	Perform quick math operations and unit conversions.
________________________________________
Future Enhancements
•	Zara
•	A weather bot
